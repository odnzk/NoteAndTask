...
enum class TodoDeadline(@StringRes val titleId: Int) {
...
enum class TodoReminder(@StringRes val titleId: Int) {
...
enum class TodoPeriodicity(@StringRes val titleId: Int, duration: Duration? = null) {
    ...
    CUSTOM(R.string.todo_setting_period_custom, null) //todo
}
